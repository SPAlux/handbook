...
\url{http://slpramod.weebly.com/uploads/3/3/2/7/3327933/how_to_get_a_phd.pdf}

A presentation on how to finish a PhD: Advice for Finishing that Damn Ph.D. By Prof. Daniel M. Berry (dberry@abuwaterloo.ca)
UCLA, USA, 
Technion, Israel, 
University of Waterloo, Canada\\
\url{https://cs.uwaterloo.ca/~dberry/FTP_SITE/lecture.slides/finishing.phd.talk.pdf}

Some more advices for PhD students:\\
\url{https://sites.google.com/site/asergrp/advice}\\
...
In case you have problems with the moodle login, you can contact Shahed Parnian (shahed.parnian@uni.lu).
...
For example, you can meet people to practice speaking French every Monday at 6 pm at Independent Caf\'e (6 Boulevard F-d Roosevelt, 2450 Luxembourg). 
It is for everyone who wants to improve their French, learn French or just hang out and speak French. \\
Source: \url{https://www.couchsurfing.org/n/repeating-events/next-french-meeting-luxembourg-repeats}\\
...
Source: \url{http://www.wort.lu/en/view/take-part-in-a-language-exchange-in-luxembourg-526e85e3e4b0b582f958e50f}
